                        ...
                        <div class="navbar-collapse collapse">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <img src="${contextPath}/resources/Images/user/milo.png" class="img-responsive img-circle" title="John Doe" alt="John Doe" width="30px" height="30px">
                                    </span>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="navbar-content">
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <img src="${contextPath}/resources/Images/user/milo.png" alt="Alternate Text" class="img-responsive" width="120px" height="120px" />
        ...
        <div class="col-lg-3 col-md-3 hidden-sm hidden-xs">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="media">
                        <div align="center">
                            <img class="thumbnail img-responsive" src="${contextPath}/resources/Images/user/milo.png" width="300px" height="300px">
                        </div>
                        <div class="media-body">
                            <hr>
                            <h3><strong>Bio</strong></h3>
                            <p>Hi! My name is Milo, my mommy just wants to show off she is awesome and amazing at containers, so she is going to use my face and name in the process. I am 3 years young and have the need for speed. Excellent at: howling, sitting patiently, running. Favorite trick: peek-a-boo </p>
                            <hr>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <br><br>
                    <i class="fa fa-tags" aria-hidden="true"></i> <a href="#" class="tag">#Husky</a> <a href="#" class="tag"> #GermanShepherd</a> <a href="#" class="tag"> #Malinois </a><a href="#" class="tag"> #Mutt</a>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="pull-left">
                        <a href="#">
                            <img class="media-object img-circle" src="${contextPath}/resources/Images/user/milo.png" width="50px" height="50px" style="margin-right:8px; margin-top:-5px;">
                        </a>
                    </div>
                    ...
                    <div class="media">
                        <div class="pull-left">
                            <a href="#">
                                <img class="media-object img-circle" src="${contextPath}/resources/Images/user/milo.png" width="35px" height="35px" style="margin-left:3px; margin-right:-5px;">
                            </a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="post-content">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <h4><a href="#" style="text-decoration:none;"><strong>Andrea Peterson</strong></a> <small><small><a href="#" style="text-decoration:none; color:grey;"><i><i class="fa fa-clock-o" aria-hidden="true"></i> about 10 hours ago</i></a></small></small></h4>
                                <hr>
                                <div class="post-content">
                                     <p>Wow, Milo is truly the best dog to ever exist. </p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <hr>
                    <div class="post-content">
                        <p>Did I mention I hate cats?</p>
                        <img class="img-responsive" src="${contextPath}/resources/Images/user/giphy.gif">
                        <p><br><a href="#" class="tag">#  I am scared</a> <a href="#" class="tag">#  SorryNotSorry</a></p>
                    </div>
                    <hr>
                    <div>
                        <div class="pull-right btn-group-xs">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <hr>
                    <div class="post-content">
                        <p>"Just awoke from the best snooze of my life."</p>
                    </div>
                    <hr>
                    <div>
                        <div class="pull-right btn-group-xs">
                        ...
                        <div class="post-content">
                            <div class="panel-default">
                                <div class="panel-body">
                                    ...
                                    <h4><a href="#" style="text-decoration:none;"><strong>Andrea Peterson</strong></a></h4>
                                    <hr>
                                    <div class="post-content">
                                        <p>Oh I know, I heard you snore.</p>
                        ...
                        <div class="post-content">
                            <div class="panel-default">
                                <div class="panel-body">
                                    <div class="pull-left">
                                        <a href="#">
                                            <img class="media-object img-circle" src="${contextPath}/resources/Images/user/milo.png" width="35px" height="35px" style="margin-right:8px; margin-top:-5px;">
                                        </a>
                                    </div>
